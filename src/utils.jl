...
pairwise(d::PreMetric, x::AbstractVector, y::ColVecs) = Distances.pairwise(d, hcat(x...), y.X; dims=2)
pairwise(d::PreMetric, x::ColVecs, y::AbstractVector) = Distances.pairwise(d, x.X, hcat(y...); dims=2)
...
pairwise(d::PreMetric, x::AbstractVector, y::RowVecs) = Distances.pairwise(d, transpose(hcat(x...)), y.X; dims=1)
pairwise(d::PreMetric, x::RowVecs, y::AbstractVector) = Distances.pairwise(d, x.X, transpose(hcat(y...)); dims=1)
